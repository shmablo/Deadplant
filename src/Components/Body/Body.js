...
import Footer from "../Footer/Footer"; // Correct the import path
    ...
    <div className="body-container">
      ...
      <div className="text-overlay">
        <div className="text-container">
          <h1>Deadplant</h1>
          <p>
            The only <span className="highlight">Deadlock strategy tool</span>{" "}
            designed from
      ...
      <Footer showFooterText={true} /> {/* Add Footer component here */}
    </div>
  );
};
